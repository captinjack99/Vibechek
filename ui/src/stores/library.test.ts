/**
 * Regression test: the global audio player kept a stale path after
 * organize moved the loaded track, so replay errored out.
 *
...
/**
 * Regression test: trashed/moved duplicates were never removed from the
 * in-memory library.
 *
