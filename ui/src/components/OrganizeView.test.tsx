...
/**
 * F002 — the confirmed preview MUST match what executes.
 *
...
/**
 * F025 — the post-organize folder breakdown is the screen the user reads before
...
/**
 * F075 — `relative_destination` is optional on the wire. The destructive
...
/**
 * F076 — an undo that restored nothing is not "Undone".
 */
...
// ---------------------------------------------------------------------------
// F058/F047 — a CANCELLED undo resolves like a success.
//
...
describe("<OrganizeView /> — cancelled undo", () => {
  ...
  // F076 — the retry's own result must replace the previous attempt's panel.
