...
/**
 * Regression test: DuplicatesView calls `begin("dedupe-handle")` for the
 * DESTRUCTIVE half of dedupe, `OperationKind` has the member, but the label
 * table lacked a matching entry — so the overlay rendered the raw id
 * "dedupe-handle" as its headline while files were being sent to the trash.
 */
