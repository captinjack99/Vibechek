...
export function LibraryBrowser() {
   ...
   *   - Same Camelot key (a future chip group could widen this to harmonic
  ...
  const handleFindCompatible = useCallback(() => {
    ...
    // Key: same Camelot. A camelot chip group, if wired, could let
    // the DJ click "harmonic" / "energy" to widen. We seed with just the
    // exact key — the safe, always-correct fallback.
    if (ml.ml_key) {
