/**
 * Two Settings-page honesty fixes.
 *
 *  1.  The "Set up CLAP genre engine" button must be hidden on the native
 ...
 *
 *  2.  refreshPreflight must send the SELECTED engine so the readiness banner
...
describe("<Settings /> — worker-slider memory refusal", () => {
...
// ---------------------------------------------------------------------------
// The run sizes each worker for the longest track in the loaded library,
...
describe("<Settings /> — verify-models failure points at Download models", () => {
...
// ---------------------------------------------------------------------------
// The two vocal-band sliders overlap on [0.5, 0.95] and the Hint tells
...
// ---------------------------------------------------------------------------
// Merely OPENING Settings must not write the config while the load is
...
// ---------------------------------------------------------------------------
// `loadUntrusted` gates the first-launch tour (App.tsx) and the
