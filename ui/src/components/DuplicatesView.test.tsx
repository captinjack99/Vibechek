...
// ---------------------------------------------------------------------------
// F021 / F022 / F071 — a destructive resolve must report a cancelled batch as
...
// ---------------------------------------------------------------------------
// F022 / F072 — the helpers that map a report onto the files the sidecar acts
...
// ---------------------------------------------------------------------------
// F072 — skipping one group must not silently drop its key-twin.
//
...
// ---------------------------------------------------------------------------
// WP-E2 wire additions on the dedupe summary: `journal_incomplete` (the undo
...
describe("<DuplicatesView /> — dedupe undo record and resolved paths", () => {
  ...
  // F022 (residual) — a MOVE is not a removal. `moved_pairs` carries the real
