 ...
 * truth alongside tailwind.config.js — if you change a value there, change it
 * here too (they're asserted equal in spirit, not build-enforced).
 */

/** accent.DEFAULT — the brand purple. */
export const ACCENT = "#a855f7";

/** The 1-5 energy ramp (energy.* in tailwind.config.js). */
