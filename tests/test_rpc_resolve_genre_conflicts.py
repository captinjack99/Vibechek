...
def test_track_without_ml_is_reported_not_silently_skipped() -> None:
    ...
    a success for a resolve that never persisted (audit 2026-09-05 F094).
    """
    _seed(
        "/lib",
...
# ---------------------------------------------------------------------------
# a resolve that matched nothing must not look like a success (F094)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# resolve and import_tag_priors must not race on the saved analysis (F057)
# ---------------------------------------------------------------------------
