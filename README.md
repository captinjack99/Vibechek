...
> **Status:** `v0.9.2-beta` — public beta, feature-complete, headed for stable. Battle-tested on a real 12,000-track personal library. Cross-platform (Windows / macOS / Linux); on Windows the WSL-free native analysis engine bundled into the installer is now the default. Free forever under AGPL-3.0.
